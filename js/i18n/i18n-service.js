...
DRC.I18n = (() => {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            "chart": { "average": "Average", "avgShort": "Avg", "lower": "lower", "higher": "higher", "yourRisk": "your risk", "thanAverage": "than the average of", "filterLabel": "Show above average risk factors only", "betterThanAvg": "Better than average", "betterShort": "Better", "worseThanAvg": "Worse than average", "worseShort": "Worse", "clickForInfo": "Click for info", "verb": { "increasing": "Increasing", "lowering": "Lowering" }, "info": { "binaryIncrease": "Your {factor} increases your overall diabetes risk by {pct}. <strong>Check the treatment section on the right.</strong>", "binaryDecrease": "Your {factor} decreases your overall diabetes risk by {pct} compared to an average person.", "aboveIncrease": "Your {factor} is above average and increases your overall diabetes risk by {pct} compared to an average value. <strong>{verb} it would help to decrease your overall risk. Check the treatment section on the right.</strong>", "belowIncrease": "Your {factor} is below average and increases your overall diabetes risk by {pct} compared to an average value. <strong>{verb} it would help to decrease your overall risk. Check the treatment section on the right.</strong>", "aboveDecrease": "Your {factor} is above average and decreases your overall diabetes risk by {pct} compared to an average value.", "belowDecrease": "Your {factor} is below average and decreases your overall diabetes risk by {pct} compared to an average value." } },
            ...
            "settings": { "model": "Prediction Model", "language": "Language", "darkMode": "Dark Mode", "units": "Units" },
        ...
        de: {
            ...
            "settings": { "model": "Vorhersagemodell", "language": "Sprache", "darkMode": "Dunkelmodus", "units": "Einheiten" },
        ...
        fr: {
            ...
            "chart": { "average": "Moyenne", "avgShort": "Moy", "lower": "inférieur", "higher": "supérieur", "yourRisk": "votre risque", "thanAverage": "que la moyenne de", "filterLabel": "Afficher uniquement les facteurs de risque supérieurs à la moyenne", "betterThanAvg": "Mieux que la moyenne", "betterShort": "Mieux", "worseThanAvg": "Pire que la moyenne", "worseShort": "Pire", "clickForInfo": "Cliquer pour info", "verb": { "increasing": "Augmenter", "lowering": "Réduire" }, "info": { "binaryIncrease": "Votre {factor} augmente votre risque global de diabète de {pct}. <strong>Consultez la section de traitement à droite.</strong>", "binaryDecrease": "Votre {factor} réduit votre risque global de diabète de {pct} par rapport à une personne moyenne.", "aboveIncrease": "Votre {factor} est supérieur à la moyenne et augmente votre risque global de diabète de {pct} par rapport à une valeur moyenne. <strong>{verb} aiderait à réduire votre risque global. Consultez la section de traitement à droite.</strong>", "belowIncrease": "Votre {factor} est inférieur à la moyenne et augmente votre risque global de diabète de {pct} par rapport à une valeur moyenne. <strong>{verb} aiderait à réduire votre risque global. Consultez la section de traitement à droite.</strong>", "aboveDecrease": "Votre {factor} est supérieur à la moyenne et réduit votre risque global de diabète de {pct} par rapport à une valeur moyenne.", "belowDecrease": "Votre {factor} est inférieur à la moyenne et réduit votre risque global de diabète de {pct} par rapport à une valeur moyenne." } },
            ...
            "settings": { "model": "Modèle de Prédiction", "language": "Langue", "darkMode": "Mode Sombre", "units": "Unités" },
        ...
        es: {
            ...
            "chart": { "average": "Promedio", "avgShort": "Prom", "lower": "inferior", "higher": "superior", "yourRisk": "su riesgo", "thanAverage": "que el promedio de", "filterLabel": "Mostrar solo factores de riesgo por encima del promedio", "betterThanAvg": "Mejor que el promedio", "betterShort": "Mejor", "worseThanAvg": "Peor que el promedio", "worseShort": "Peor", "clickForInfo": "Hacer clic para info", "verb": { "increasing": "Aumentar", "lowering": "Reducir" }, "info": { "binaryIncrease": "Su {factor} aumenta su riesgo general de diabetes en {pct}. <strong>Consulte la sección de tratamiento a la derecha.</strong>", "binaryDecrease": "Su {factor} reduce su riesgo general de diabetes en {pct} en comparación con una persona promedio.", "aboveIncrease": "Su {factor} está por encima del promedio y aumenta su riesgo general de diabetes en {pct} en comparación con un valor promedio. <strong>{verb} ayudaría a reducir su riesgo general. Consulte la sección de tratamiento a la derecha.</strong>", "belowIncrease": "Su {factor} está por debajo del promedio y aumenta su riesgo general de diabetes en {pct} en comparación con un valor promedio. <strong>{verb} ayudaría a reducir su riesgo general. Consulte la sección de tratamiento a la derecha.</strong>", "aboveDecrease": "Su {factor} está por encima del promedio y reduce su riesgo general de diabetes en {pct} en comparación con un valor promedio.", "belowDecrease": "Su {factor} está por debajo del promedio y reduce su riesgo general de diabetes en {pct} en comparación con un valor promedio." } },
            ...
            "settings": { "model": "Modelo de Predicción", "language": "Idioma", "darkMode": "Modo Oscuro", "units": "Unidades" },

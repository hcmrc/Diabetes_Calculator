...
DRC.I18n = (() => {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            "modals": { "profileWarning": { "title": "Save Your Data?", "message1": "You haven't created a profile yet.", "message2": "Create a profile to save your data and track your progress over time. Without a profile, your data may be lost when you close the browser.", "create": "Create Profile", "continue": "Continue Without Saving", "cancel": "Cancel" }, "simulationSaveWarning": { "message": "You have an active treatment simulation. What would you like to save?", "saveOriginal": "Save Original", "saveSimulated": "Save Simulated", "saveBoth": "Save Both", "suffixOriginal": "(Original)", "suffixSimulated": "(Simulated)" }, "simulationCloseWarning": { "message": "You saved a profile. The simulation is still active. What would you like to do?", "messageBoth": "You saved both profiles. Which would you like to load?", "loadProfile": "Load Profile", "loadOriginal": "Load Original Profile", "loadSimulated": "Load Simulated Profile", "keepCurrent": "Keep Current State" }, "ocr": { "title": "Scan Lab Report", "instructions": "Take a photo or upload your lab report", "camera": "Camera", "upload": "Upload File", "review": "Review Results", "confidence_high": "High confidence", "confidence_medium": "Medium confidence", "confidence_low": "Low confidence", "processing": "Processing...", "reviewTitle": "Review Values", "errorTitle": "Processing Error", "errorMessage": "Could not process image. Please try again." } },
        ...
        de: {
            ...
            "modals": { "profileWarning": { "title": "Daten speichern?", "message1": "Sie haben noch kein Profil erstellt.", "message2": "Erstellen Sie ein Profil, um Ihre Daten zu speichern und Ihren Fortschritt zu verfolgen. Ohne ein Profil können Ihre Daten beim Schließen des Browsers verloren gehen.", "create": "Profil erstellen", "continue": "Ohne Speichern fortfahren", "cancel": "Abbrechen" }, "simulationSaveWarning": { "message": "Eine Behandlungssimulation ist aktiv. Was möchten Sie speichern?", "saveOriginal": "Originalwerte speichern", "saveSimulated": "Simulierte Werte speichern", "saveBoth": "Beide speichern", "suffixOriginal": "(Original)", "suffixSimulated": "(Simuliert)" }, "simulationCloseWarning": { "message": "Sie haben ein Profil gespeichert. Die Simulation ist noch aktiv. Was möchten Sie tun?", "messageBoth": "Sie haben beide Profile gespeichert. Welches möchten Sie laden?", "loadProfile": "Profil laden", "loadOriginal": "Originalprofil laden", "loadSimulated": "Simuliertes Profil laden", "keepCurrent": "Aktuellen Zustand behalten" }, "ocr": { "title": "Labbericht scannen", "instructions": "Machen Sie ein Foto oder laden Sie Ihren Labbericht hoch", "camera": "Kamera", "upload": "Datei hochladen", "review": "Ergebnisse prüfen", "confidence_high": "Hohe Konfidenz", "confidence_medium": "Mittlere Konfidenz", "confidence_low": "Niedrige Konfidenz", "processing": "Verarbeite...", "reviewTitle": "Werte prüfen", "errorTitle": "Verarbeitungsfehler", "errorMessage": "Bild konnte nicht verarbeitet werden. Bitte versuchen Sie es erneut." } },
        ...
        fr: {
            ...
            "modals": { "profileWarning": { "title": "Enregistrer vos Données?", "message1": "Vous n'avez pas encore créé de profil.", "message2": "Créez un profil pour sauvegarder vos données et suivre vos progrès. Sans profil, vos données peuvent être perdues à la fermeture du navigateur.", "create": "Créer Profil", "continue": "Continuer Sans Sauvegarder", "cancel": "Annuler" }, "simulationSaveWarning": { "message": "Une simulation de traitement est active. Que souhaitez-vous enregistrer ?", "saveOriginal": "Enregistrer les valeurs d'origine", "saveSimulated": "Enregistrer les valeurs simulées", "saveBoth": "Enregistrer les deux", "suffixOriginal": "(Original)", "suffixSimulated": "(Simulé)" }, "simulationCloseWarning": { "message": "Vous avez enregistré un profil. La simulation est toujours active. Que souhaitez-vous faire ?", "messageBoth": "Vous avez enregistré les deux profils. Lequel souhaitez-vous charger ?", "loadProfile": "Charger le profil", "loadOriginal": "Charger le profil original", "loadSimulated": "Charger le profil simulé", "keepCurrent": "Conserver l'état actuel" }, "ocr": { "title": "Scanner Rapport Labo", "instructions": "Prenez une photo ou téléchargez votre rapport de laboratoire", "camera": "Caméra", "upload": "Télécharger Fichier", "review": "Vérifier Résultats", "confidence_high": "Confiance élevée", "confidence_medium": "Confiance moyenne", "confidence_low": "Confiance faible", "processing": "Traitement...", "reviewTitle": "Vérifier Valeurs", "errorTitle": "Erreur de Traitement", "errorMessage": "Impossible de traiter l'image. Veuillez réessayer." } },
        ...
        es: {
            ...
            "modals": { "profileWarning": { "title": "¿Guardar sus Datos?", "message1": "Aún no ha creado un perfil.", "message2": "Cree un perfil para guardar sus datos y seguir su progreso. Sin un perfil, sus datos pueden perderse al cerrar el navegador.", "create": "Crear Perfil", "continue": "Continuar Sin Guardar", "cancel": "Cancelar" }, "simulationSaveWarning": { "message": "Hay una simulación de tratamiento activa. ¿Qué desea guardar?", "saveOriginal": "Guardar valores originales", "saveSimulated": "Guardar valores simulados", "saveBoth": "Guardar ambos", "suffixOriginal": "(Original)", "suffixSimulated": "(Simulado)" }, "simulationCloseWarning": { "message": "Ha guardado un perfil. La simulación sigue activa. ¿Qué desea hacer?", "messageBoth": "Ha guardado ambos perfiles. ¿Cuál desea cargar?", "loadProfile": "Cargar perfil", "loadOriginal": "Cargar perfil original", "loadSimulated": "Cargar perfil simulado", "keepCurrent": "Mantener estado actual" }, "ocr": { "title": "Escanear Informe Lab", "instructions": "Tome una foto o suba su informe de laboratorio", "camera": "Cámara", "upload": "Subir Archivo", "review": "Revisar Resultados", "confidence_high": "Alta confianza", "confidence_medium": "Confianza media", "confidence_low": "Baja confianza", "processing": "Procesando...", "reviewTitle": "Revisar Valores", "errorTitle": "Error de Procesamiento", "errorMessage": "No se pudo procesar la imagen. Inténtelo de nuevo." } },
